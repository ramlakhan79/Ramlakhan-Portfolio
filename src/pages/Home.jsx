...
export default function Home() {
    ...
    return (
        <>
            <SplashSection splashMessage={'Ramlakhan'} isDarkMode={isDarkMode} isErrorMode={false} />
